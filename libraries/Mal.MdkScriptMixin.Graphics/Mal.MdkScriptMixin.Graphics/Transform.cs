...
namespace IngameScript
{
    public struct Transform
    {
        ...
        {
            if (Scale == 0f)
                throw new InvalidOperationException("Transform2D is not invertible when Scale is 0.");
        ...
        /// <summary>
        ///     Transforms a point by the inverse transform without allocating an intermediate inverse.
        /// </summary>
