...
Visual Studio can automatically create the proper folder structure when you create a new solution with the "Place solution and project in the same directory" option disabled.

1. In Visual Studio, go to **File → New → Project**
2. Search for **"MDK Mixin"** template
3. Click **Next**
4. Set the project name to match your library name following the naming convention:
...
5. Set the location to the `libraries` folder in your cloned repository
6. **Uncheck "Place solution and project in the same directory"** - This creates the proper folder structure automatically
7. Click **Create**
...
1. Right-click the shared project in Solution Explorer
...
1. In Visual Studio, go to **File → New → Project**
2. Search for **"MDK Programmable Block Script"** template
3. Click **Next**
...
1. Right-click the Demo project in Solution Explorer
2. Select **Add → Reference**
3. In the left panel, select **Shared Projects**
4. Check your mixin project
5. Click **OK**
...
4. Click **Commit All**
5. Click **Push** to upload to **your fork**
