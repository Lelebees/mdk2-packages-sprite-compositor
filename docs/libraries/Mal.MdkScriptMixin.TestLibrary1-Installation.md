# Installing Mal.MdkScriptMixin.TestLibrary1
...
5. Click **OK** to save
6. Search for `Mal.MdkScriptMixin.TestLibrary1`
7. Click **Install**
...
5. Search for `Mal.MdkScriptMixin.TestLibrary1`
6. Click **Install**
...
```bash
dotnet add package Mal.MdkScriptMixin.TestLibrary1
```
...
```xml
<PackageReference Include="Mal.MdkScriptMixin.TestLibrary1" Version="1.2.3" />
```
