...
> 
> **Description:** API wrapper simplifying the native Space Engineers LCD Sprite API. Supports composing your own sprites out of a collection of existing sprites.
>
> **[Installation Instructions →](./Lelebees.MdkScriptMixin.SpriteCompositor-Installation.md)** | **[Release Notes →](./Lelebees.MdkScriptMixin.SpriteCompositor-ReleaseNotes.md)**
...
*Documentation auto-generated from package metadata. Last updated: 2026-05-22*
