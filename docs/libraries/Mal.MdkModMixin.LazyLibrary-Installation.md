# Installing Mal.MdkModMixin.LazyLibrary
...
5. Click **OK** to save
6. Search for `Mal.MdkModMixin.LazyLibrary`
7. Click **Install**
...
5. Search for `Mal.MdkModMixin.LazyLibrary`
6. Click **Install**
...
```bash
dotnet add package Mal.MdkModMixin.LazyLibrary
```
...
```xml
<PackageReference Include="Mal.MdkModMixin.LazyLibrary" Version="2.0.0" />
```
